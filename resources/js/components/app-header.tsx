...
const activeItemStyles = 'text-foreground dark:bg-accent dark:text-foreground';
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="bg-sidebar flex h-full w-64 flex-col items-stretch justify-between">
                                ...
                                <div className="mt-6 flex h-full flex-1 flex-col gap-4">
                                    <div className="flex h-full flex-col justify-between text-sm">
                                        <div className="flex flex-col gap-4">
                                            {mainNavItems.map((item) => (
                                                <Link key={item.title} href={item.url} className="flex items-center gap-2 font-medium">
