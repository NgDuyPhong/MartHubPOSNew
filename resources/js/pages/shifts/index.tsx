...
export default function ShiftsPage({
    ...
    const openForm = useForm<{ register_id: number; opening_cash: number | '' }>({ register_id: registers[0]?.id ?? 0, opening_cash: 0 });
    ...
    const cashForm = useForm<{ type: string; amount: number | ''; reason: string }>({ type: 'out', amount: 0, reason: '' });
